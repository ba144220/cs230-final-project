...
sys.path.append("/work/yuchi/stanford/2024-fall/cs230/cs230-final-project/src")
import os
...
from parsers.argument_classes import DatasetArguments, ModelArguments, TrainingArguments, GenerationArguments, ExperimentArguments
...
def main():
    parser = HfArgumentParser((DatasetArguments, ModelArguments, TrainingArguments, GenerationArguments, ExperimentArguments))
    if len(sys.argv) == 2 and sys.argv[1].endswith(".yaml"):
        dataset_args, model_args, training_args, generation_args, experiment_args = parser.parse_yaml_file(sys.argv[1])
    else:
        dataset_args, model_args, training_args, generation_args, experiment_args = parser.parse_args_into_dataclasses()
    ...
    table_llama_config.rope_table_llama = {
        ...
        "noise_level": experiment_args.noise_level,
    }
